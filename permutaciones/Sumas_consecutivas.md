...
# Versión utilizando _while_
Esta versión es como los bloopers de las películas, la dejo por si a alguien le interesa verla, también está correcta =)
```C++
#include <bits/stdc++.h>
using namespace std;
int n,k;
